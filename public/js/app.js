...
document.addEventListener('DOMContentLoaded', function (event) {
  ...
  var containerMenu = document.querySelector('.navbar-mobile_menu');
  var sliderServices = document.querySelector('.header-slider_service_3d');
  var containerNavbar = document.querySelector('.navbar-container');
